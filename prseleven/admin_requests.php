...
<body>
    <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <li class="nav-item">
            <a class="nav-link" href="list_eqi.php" style="color:white;">View Requests <span class="badge badge-pill" style="background-color:#2196f3;"><!--?php include('count_eqi.php');?--></span></a>
            </li>
    ...
    <h1>Admin Panel - View Requests</h1>
    ...
    <div class="mycontainer">
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                        ...
                        <?php
                                global $row;
                                $query = mysqli_query($conn,"SELECT * FROM tabforthis WHERE status='Pending'");
                               ...
                               if($query){
                                    ...
                                    if($numrow!=0){
                                       ...
                                       // after [[<td>{$row['descr']}</td>]]]  <td>{$datetime1->format('Y/m/d')} <b>--</b> {$datetime2->format('Y/m/d')}</td>
                                    ...
                                    echo "Query Error : " . "SELECT * FROM tabforthis WHERE status='Pending'" . "<br>" . mysqli_error($conn);
                                }
                       ?> 

...
<!-- php code -->
  ...
  if(isset($_POST['submit'])){
    ...
    if($validate){
      signup($fullname,$username,$email,$password,$phone,$repassword,$gender,$type,$conn);
    }
  }
...
error_reporting(E_ALL);
  ...
  <nav class="navbar header-nav navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Property Price System</a>
  ...
  <form method="POST" autocomplete="off">
    ...
    <br>
      ...
      <div class="row">
            ...
            <div class="col-5">
                <label for="User Type">Type of Account</label><br>
                <input type="radio" checked=true id="type" name="type" <?php if(isset($type)&&$type=="client") echo "checked" ?> value="client">Client
      </div>
                    </div>
